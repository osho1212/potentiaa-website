...
const DEFAULT_GLOW_COLOR = "99, 102, 241"; // Brand Indigo / Violet
...
export default function MagicBento({
  ...
  return (
    <>
      ...
      <div
        className={`magic-bento-grid ${theme === "light" ? "magic-bento-grid--light" : ""}`}
        ref={gridRef}
      >
        {items.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor:
                card.color || (theme === "light" ? "#f8fafc" : "rgba(14, 16, 27, 0.65)"),
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  <span className="magic-bento-card__label">{card.index || card.label}</span>
                </div>
          ...
          return (
            <div key={card.index || index} {...cardProps}>
              <div className="magic-bento-card__header">
                <span className="magic-bento-card__label">{card.index || card.label}</span>
              </div>
              <div className="magic-bento-card__content">
